...
// Components
import { PasswordInsetInput as Component, PasswordInsetInputProps } from './PasswordInsetInput'

describe('<PasswordInsetInput />', () => {
    const TESTID = 'input'

    const defaultProps: PasswordInsetInputProps = {
        id: 'test-input',
        label: 'Label',
    }
