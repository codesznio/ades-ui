...
import { ContentHeaderHeroSecondary as Component, ContentHeaderHeroSecondaryProps } from './ContentHeaderHeroSecondary'

describe('<ContentHeaderHeroSecondary />', () => {
    const TESTID = 'header'
    const baseProps: ContentHeaderHeroSecondaryProps = {
        content: {
