...
import { ContentHeaderPrimary as Component, ContentHeaderPrimaryProps } from './ContentHeaderPrimary'

describe('<ContentHeaderPrimary />', () => {
    const TESTID = 'header'
    const baseProps: ContentHeaderPrimaryProps = {
        content: {
